...
- 12 guided trails, 294 original teaching entries, and two examples plus a misconception note per entry.
- Flexible First steps (K–2), Explorer (3–5), Investigator (6–8), Scholar (9–12), and Adult rebuild paths. These are editorial suggestions, not standardized grade placements.
