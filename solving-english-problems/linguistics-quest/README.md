...
A standalone, dependency-free world inside **Solving English Problems** (`../`), next to Sentence Forge and Word Raiders. The previous `engineering-quest/public/linguistics-quest/` location redirects here. Every screen is deep-linkable: `#home`, `#course`, `#explore`, `#world/<trail>`, `#library`, `#arcade`, `#arcade/<mode>`, `#repair`, `#progress`, `#guide`, `#reference`, `#visual-library`, and `academy/#library` / `#review` / `#about`.
